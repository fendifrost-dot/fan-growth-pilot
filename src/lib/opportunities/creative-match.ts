...
// supabase/functions/_shared/opportunities/creative-match.ts so the opportunities-api Edge
...
export * from "../../../supabase/functions/_shared/opportunities/creative-match.ts";
