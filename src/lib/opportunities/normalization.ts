...
// supabase/functions/_shared/opportunities/normalization.ts so the opportunities-api Edge
...
export * from "../../../supabase/functions/_shared/opportunities/normalization.ts";
