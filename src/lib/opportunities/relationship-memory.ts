...
// supabase/functions/_shared/opportunities/relationship-memory.ts so the opportunities-api Edge
...
export * from "../../../supabase/functions/_shared/opportunities/relationship-memory.ts";
