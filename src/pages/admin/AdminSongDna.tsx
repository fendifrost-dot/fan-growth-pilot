    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-2">
          Apply migration <code>20260903000000_song_dna_versions.sql</code> via Lovable SQL Editor
          before using this page in production.{" "}
          <Link to="/admin/pitch-portal" className="underline">
            Pitch Portal
          </Link>{" "}
          requires an approved version to activate.
        </p>
      </div>
