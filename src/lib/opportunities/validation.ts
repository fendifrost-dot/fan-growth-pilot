...
// supabase/functions/_shared/opportunities/validation.ts so the opportunities-api Edge
...
export * from "../../../supabase/functions/_shared/opportunities/validation.ts";
