-- Final database-consistency correction: atomic inventory persist, active
-- idempotency index, handoff open-pair preflight, safer emergency compensate.
...
-- ---------------------------------------------------------------------------
-- 2. Handoff open-pair duplicate preflight (read-only) + reconcile plan
-- ---------------------------------------------------------------------------
...
-- Ensure unique index exists (created in 140000; recreate if dropped for preflight).
...
-- ---------------------------------------------------------------------------
-- 3. Safer emergency compensate: emptiness via locked count(*), ordered cleanup
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 4. Lookup matches active uniqueness rule
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 5. Atomic inventory persist (one transaction for batch + drafts + records)
-- ---------------------------------------------------------------------------
