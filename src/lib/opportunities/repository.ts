...
// supabase/functions/_shared/opportunities/repository.ts so the opportunities-api Edge
...
export * from "../../../supabase/functions/_shared/opportunities/repository.ts";
